def print_comparison(name, dates, times, original_data, computed_data):
    """
    Print a comparison of two time series original and computedo
    Parameters:
        name: A string for the data being compared limited to 9 characters in length
        dates: List of strings representing dates 
        original data: List of original data (floats)
        computed data
    """
